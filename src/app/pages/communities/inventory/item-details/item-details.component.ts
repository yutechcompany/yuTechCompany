...
import { reviewsModel } from './item-details.model';
// Swiper
...
export class ItemDetailsComponent {
  ...
  constructor(private formBuilder: UntypedFormBuilder, private http: HttpClient, private route: Router) { }
  ...
  gotoEdit() {
    return this.route.navigate(['/communities/inventory/add-item'])
  }
