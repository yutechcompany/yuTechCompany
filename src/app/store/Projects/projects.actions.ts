...
import { dealModel, leadModel, tableModel, taskModel } from './projects.model';

export const fetchtableData = createAction('[Data] Fetch table Data');
export const fetchtableSuccess = createAction('[Data] Fetch table Data Success', props<{ projectsData: tableModel[] }>());
